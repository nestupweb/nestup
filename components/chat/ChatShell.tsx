 ...
 * header, the layout's pt-4 under it, its own top margin and the floating bottom
...
export function ChatShell({ list, children }: { list: ReactNode; children: ReactNode }) {
  ...
  return (
    <div className="sm:px-6 lg:mt-4 lg:grid lg:h-[calc(100dvh-13.125rem)] lg:min-h-[30rem] lg:grid-cols-[22rem_minmax(0,1fr)] lg:overflow-hidden lg:rounded-3xl lg:border lg:border-hairline lg:bg-surface lg:shadow-sm">
      <aside
