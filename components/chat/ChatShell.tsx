 ...
 * header, its own top margin and the floating bottom nav so the page itself
 * never scrolls. Chat pages show no "← Back to …" row.
 */
export function ChatShell({ list, children }: { list: ReactNode; children: ReactNode }) {
  ...
  return (
    <div className="sm:px-6 lg:mt-4 lg:grid lg:h-[calc(100dvh-12.125rem)] lg:min-h-[30rem] lg:grid-cols-[22rem_minmax(0,1fr)] lg:overflow-hidden lg:rounded-3xl lg:border lg:border-hairline lg:bg-surface lg:shadow-sm">
      <aside
