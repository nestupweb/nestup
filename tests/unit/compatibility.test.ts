...
function profile(overrides: Partial<Profile> = {}): Profile {
  return {
    ...
    pref_cleanliness: 1, pref_sleep: "any", pref_guests: "any", pref_noise: "any", pref_diet: "any", pref_shabbat: "any", gender: null, pref_same_gender: false,
...
function listing(overrides: Partial<Listing> = {}): Listing {
  return {
    ...
    roommates_count: 2, household_size: 2,
