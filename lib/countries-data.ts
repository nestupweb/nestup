/**
 * Countries with their international dialling code, for the phone-number
 * country picker. Generated from libphonenumber-js metadata + Intl region
 * names (English), alphabetical; flags live in `public/flags/{code}.svg`
 * (country-flag-icons, 3×2). Regenerate rather than hand-edit.
 */
