...
await page.goto("https://nestup-kappa.vercel.app/browse/9f4d0086-9a1c-4b5b-9bd0-9d2f3b8a0000", { waitUntil: "domcontentloaded" }).catch(() => {});
await page.goto("https://nestup-kappa.vercel.app/browse", { waitUntil: "domcontentloaded" });
const hrefs = await page.locator('a[href^="/browse/"]').evaluateAll((e) => [...new Set(e.map((x) => x.getAttribute("href")))]);
for (const h of hrefs) {
  await page.goto("https://nestup-kappa.vercel.app" + h, { waitUntil: "domcontentloaded" });
